classdef BallTracker
    ...
    methods
        ...
        function showScores(obj)
            if obj.score == 1
                     text(3, 0.5, num2str(1), 'FontSize', 24, 'HorizontalAlignment', 'right');
            text(8, 0.5, num2str(obj.scoreRight), 'FontSize', 24, 'HorizontalAlignment', 'left');
            else
        ...
        function [ball,obj] = isPointInRectangle(obj,x, y,ball)
        ...
        function  [ball,obj] = isPointInrightRectangle(obj,x, y,ball)
        % isPointInRectangle Check if a point is within a rectangle
        %   INPUTS: 
        %       x, y : coordinates of the point to check
        %       x1, y1 : coordinates of the bottom-left corner of the rectangle
