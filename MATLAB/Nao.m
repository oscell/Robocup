        ...
        function [obj,ball] = checkColision(obj,robots,timestep,ball)
            ...
            for robot = robots
                ...
                if counter ~= obj.ID
                    ...
                    if distance < obj.radius*2 && timestep > (obj.timeSetpFell + 100) && robot.ID ~= obj.lastCollisionrobot 
                        obj.lastCollisionrobot = robot.ID;
